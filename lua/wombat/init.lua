...
function M.setup(opts)
	vim.g.wombat_ansi_colors_name = opts["ansi_colors_name"]
end
...
function M.set_colorscheme(colors_name, theme_module, default_ansi_colors_name)
	...
	local ansi_colors_name = (
		vim.g.wombat_ansi_colors_name
		or default_ansi_colors_name
		or theme_module.default_ansi_colors_name
	)
